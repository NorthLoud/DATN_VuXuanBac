        ...
        <div id="chatbot-window">
            ...
            <div class="chatbot-messages" id="chatbot-messages-list">
                <div class="chat-message bot">
                    Chào anh! Em là trợ lý ảo <strong>LoudBooking AI</strong>. Anh muốn tìm kiếm khách sạn, kiểm tra phòng trống hay cần thông tin ưu đãi nào không ạ? Em rất sẵn lòng hỗ trợ anh!
                </div>
            </div>
            <div class="chatbot-suggestions">
                <button class="suggestion-btn" data-query="Tìm khách sạn ở Hà Nội">Tìm khách sạn ở Hà Nội</button>
                <button class="suggestion-btn" data-query="Có những mã giảm giá (voucher) nào?">Tìm Voucher</button>
                <button class="suggestion-btn" data-query="Phòng với giá nhỏ hơn 2 triệu ở Hà Nội">Phòng với giá nhỏ hơn 2 triệu</button>
            </div>
            <div class="chatbot-input-area">
                <input type="text" class="chatbot-input" id="chatbot-text-input" placeholder="Nhập câu hỏi của anh...">
